...
* **Trip** - Knock a Target within your Reach Prone. If you beat the Target’s Endure, they fall Prone. A Target can choose to React with Block or Dodge instead of using their Endure.
* **Disarm** - Knock an object loose that is within your Reach if it is held in hand or visible on a Character’s body. The Disarm Check is made against the wielder’s relevant Weapon Skill for Reach Weapons, or Hand-to-Hand in the case of any other held item or item holstered on the body. If you make your Disarm Check with the Hand to Hand Skill with a free hand, you can take the Disarmed item into your hand on a Success.
* **Pin** - Attempt to hold-fast or tie-down a Target using either your hands, rope, or bindings. If you beat the Target’s Escape Check, you Immobilize them and prevent the use of either their arms or legs, whichever you were attempting to Pin. When not using ropes or other bindings, the Target is Immobilized for one Round, until they Escape, or you let go. If you are using rope or bindings, the Target is Immobilized until they Escape or you untie them. Targets that are much larger than you either gain Advantage or are immune to your Pin, at the GM’s discretion.
* **Strangle** - Attempt to choke a Target within your Reach. If you attempt to do this with only one hand, you have Disadvantage. If you beat the Target’s Endure or Escape Check, they suffer one failure on a Shock Check, potentially causing them to lose consciousness, and Immobilize them for one Round or until they Escape or you release your grip. While you are Strangling someone, they cannot speak. If the Target doesn’t need to breathe, they cannot be Strangled.
...
* **Accelerate** - Attempt to either increase or decrease the Distance between you and other Characters in a Chase. Choose to either pull away (increase) or catch up (decrease). This is a Contest against the Accelerate Check of the Character you are Accelerating toward or away from. Every point you beat their Check by modifies the Distance by (1).
