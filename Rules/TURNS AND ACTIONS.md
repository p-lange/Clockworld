...
* **Pin** - Attempt to hold-fast or tie-down a Target using either your hands, rope, or bindings. The Target can Contest with either Endure or Escape. If you win the Contest, you Immobilize them and prevent them use of either their arms or legs, whichever you were attempting to Pin. When not using ropes or other bindings, the Target is Immobilized for one Round, until they Escape, or you let go. If you are using rope or bindings, the Target is Immobilized until they Escape or you untie them. Targets that are much larger than you either High Roll their Check or are immune to your Pin, at the GM’s discretion.
